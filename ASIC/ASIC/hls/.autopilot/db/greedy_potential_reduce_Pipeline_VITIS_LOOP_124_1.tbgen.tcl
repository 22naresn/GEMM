set moduleName greedy_potential_reduce_Pipeline_VITIS_LOOP_124_1
set isTopModule 0
...
set cdfgNum 18
set C_modelName {greedy_potential_reduce_Pipeline_VITIS_LOOP_124_1}
...
set C_modelArgMapList {[ 
	{ "Name" : "new_col", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "icmp_ln122", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ icmp_ln122 sc_in sc_lv 1 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "icmp_ln122", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "icmp_ln122", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	icmp_ln122 { ap_none {  { icmp_ln122 in_data 0 1 } } }
