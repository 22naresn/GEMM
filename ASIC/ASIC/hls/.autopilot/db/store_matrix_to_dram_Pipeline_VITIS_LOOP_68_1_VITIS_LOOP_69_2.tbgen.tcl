...
set C_modelArgList {
	...
	{ A_dram int 32 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "cols", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "A_dram", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ A_dram sc_out sc_lv 32 signal 2 } 
	{ A_dram_ap_vld sc_out sc_logic 1 outvld 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "A_dram", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "A_dram", "role": "default" }} , 
 	{ "name": "A_dram_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "A_dram", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	...
	A_dram { ap_vld {  { A_dram out_data 1 32 }  { A_dram_ap_vld out_vld 1 1 } } }
