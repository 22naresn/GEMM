set moduleName compute_greedy_potential_score
set isTopModule 0
...
set cdfgNum 18
set C_modelName {compute_greedy_potential_score}
...
set C_modelArgMapList {[ 
	{ "Name" : "r1", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sign", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sign sc_in sc_lv 2 signal 2 } 
	{ k1 sc_in sc_lv 32 signal 3 } 
	{ k2 sc_in sc_lv 32 signal 4 } 
	{ M_cols sc_in sc_lv 32 signal 5 } 
	...
	{ M_t_i sc_in sc_lv 32 signal 10 } 
	{ M_t_o sc_out sc_lv 32 signal 10 } 
	{ M_t_o_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ M_t_capacity sc_in sc_lv 32 signal 11 } 
	{ M_rows sc_in sc_lv 32 signal 12 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sign", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "sign", "role": "default" }} , 
