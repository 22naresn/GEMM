...
HLS_SOURCES = ../../../../tb_fmm_hls.cpp ../../../../fmm_hls_greedy_potential.cpp
...
$(ObjDir)/tb_fmm_hls.o: ../../../../tb_fmm_hls.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../tb_fmm_hls.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_fmm_hls.d

$(ObjDir)/fmm_hls_greedy_potential.o: ../../../../fmm_hls_greedy_potential.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../fmm_hls_greedy_potential.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/fmm_hls_greedy_potential.d
