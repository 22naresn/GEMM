...
entity fmm_reduce_kernel_greedy_potential_reduce_with_debug_Pipeline_VITIS_LOOP_136_110 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fmm_reduce_kernel_greedy_potential_reduce_with_debug_Pipeline_VITIS_LOOP_136_110 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln136_reg_242 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage2 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal icmp_ln136_fu_131_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln138_fu_143_p1 : STD_LOGIC_VECTOR (16 downto 0);
    signal trunc_ln138_reg_246 : STD_LOGIC_VECTOR (16 downto 0);
    ...
    signal icmp_ln139_reg_276 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln141_reg_280 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage2_11001 : BOOLEAN;
    signal and_ln142_fu_186_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln142_reg_284 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln142_fu_191_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln142_reg_288 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln142_1_fu_209_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln142_1_reg_292 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln138_fu_153_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal zext_ln140_fu_167_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage1 : BOOLEAN;
    signal zext_ln145_fu_176_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal c_2_fu_40 : STD_LOGIC_VECTOR (30 downto 0) := "0000000000000000000000000000000";
    signal add_ln136_fu_137_p2 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal zext_ln136_fu_127_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln138_fu_147_p2 : STD_LOGIC_VECTOR (16 downto 0);
    signal add_ln140_fu_163_p2 : STD_LOGIC_VECTOR (16 downto 0);
    signal add_ln145_fu_172_p2 : STD_LOGIC_VECTOR (16 downto 0);
    signal icmp_ln142_fu_181_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln142_fu_181_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal sext_ln142_fu_196_p0 : STD_LOGIC_VECTOR (31 downto 0);
    signal sext_ln142_fu_196_p1 : STD_LOGIC_VECTOR (32 downto 0);
    signal sext_ln142_1_fu_206_p1 : STD_LOGIC_VECTOR (32 downto 0);
    signal sub_ln142_fu_200_p2 : STD_LOGIC_VECTOR (32 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln136_fu_131_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                M_e_addr_5_reg_252 <= zext_ln138_fu_153_p1(17 - 1 downto 0);
                    ap_predicate_pred177_state5 <= (((icmp_ln142_1_reg_292 = ap_const_lv1_1) and (or_ln142_reg_288 = ap_const_lv1_0) and (icmp_ln141_reg_280 = ap_const_lv1_0) and (icmp_ln139_reg_276 = ap_const_lv1_0)) or ((ap_const_lv1_1 = and_ln142_reg_284) and (or_ln142_reg_288 = ap_const_lv1_1) and (icmp_ln141_reg_280 = ap_const_lv1_0) and (icmp_ln139_reg_276 = ap_const_lv1_0)));
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                M_e_addr_7_reg_258 <= zext_ln140_fu_167_p1(17 - 1 downto 0);
                M_e_addr_reg_264 <= zext_ln145_fu_176_p1(17 - 1 downto 0);
                M_e_addr_reg_264_pp0_iter1_reg <= M_e_addr_reg_264;
                    ap_predicate_pred177_state6 <= (((icmp_ln142_1_reg_292 = ap_const_lv1_1) and (or_ln142_reg_288 = ap_const_lv1_0) and (icmp_ln141_reg_280 = ap_const_lv1_0) and (icmp_ln139_reg_276 = ap_const_lv1_0)) or ((ap_const_lv1_1 = and_ln142_reg_284) and (or_ln142_reg_288 = ap_const_lv1_1) and (icmp_ln141_reg_280 = ap_const_lv1_0) and (icmp_ln139_reg_276 = ap_const_lv1_0)));
    ...
    M_e_address1_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter0_reg, ap_CS_fsm_pp0_stage1, zext_ln138_fu_153_p1, ap_block_pp0_stage0, zext_ln140_fu_167_p1, ap_block_pp0_stage1)
    begin
        if (((ap_enable_reg_pp0_iter0_reg = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            M_e_address1_local <= zext_ln140_fu_167_p1(17 - 1 downto 0);
        elsif (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            M_e_address1_local <= zext_ln138_fu_153_p1(17 - 1 downto 0);
        else 
    ...
    add_ln136_fu_137_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_c) + unsigned(ap_const_lv31_1));
    add_ln138_fu_147_p2 <= std_logic_vector(unsigned(mul_ln133) + unsigned(trunc_ln138_fu_143_p1));
    add_ln140_fu_163_p2 <= std_logic_vector(unsigned(mul_ln134) + unsigned(trunc_ln138_reg_246));
    add_ln145_fu_172_p2 <= std_logic_vector(unsigned(mul_ln145) + unsigned(trunc_ln138_reg_246));
    and_ln142_fu_186_p2 <= (icmp_ln142_fu_181_p2 and icmp_ln134);
    ...
    ap_condition_exit_pp0_iter0_stage2_assign_proc : process(ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2_subdone, ap_enable_reg_pp0_iter0_reg, icmp_ln136_reg_242)
    begin
        if (((icmp_ln136_reg_242 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0_reg = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage2_subdone) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
    ...
    icmp_ln136_fu_131_p2 <= "1" when (signed(zext_ln136_fu_127_p1) < signed(new_col_3)) else "0";
    icmp_ln142_1_fu_209_p2 <= "1" when (sext_ln142_1_fu_206_p1 = sub_ln142_fu_200_p2) else "0";
    icmp_ln142_fu_181_p1 <= M_e_q1;
    icmp_ln142_fu_181_p2 <= "1" when (e1_reg_269 = icmp_ln142_fu_181_p1) else "0";
    or_ln142_fu_191_p2 <= (cmp34_i_i or and_ln142_fu_186_p2);
        sext_ln142_1_fu_206_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(e1_reg_269),33));

    sext_ln142_fu_196_p0 <= M_e_q1;
        sext_ln142_fu_196_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln142_fu_196_p0),33));

    sub_ln142_fu_200_p2 <= std_logic_vector(unsigned(ap_const_lv33_0) - unsigned(sext_ln142_fu_196_p1));
    trunc_ln138_fu_143_p1 <= ap_sig_allocacmp_c(17 - 1 downto 0);
    zext_ln136_fu_127_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_c),32));
    zext_ln138_fu_153_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln138_fu_147_p2),64));
    zext_ln140_fu_167_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln140_fu_163_p2),64));
    zext_ln145_fu_176_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln145_fu_172_p2),64));
end behav;
