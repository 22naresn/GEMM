namespace eval ::optrace {
  variable script "C:/GEMM/sep6/fmm_reduce_kernel/hls/impl/verilog/project.runs/impl_1/bd_0_wrapper.tcl"
...
set rc [catch {
  ...
  open_checkpoint C:/GEMM/sep6/fmm_reduce_kernel/hls/impl/verilog/project.runs/impl_1/bd_0_wrapper.dcp
  set_property webtalk.parent_dir C:/GEMM/sep6/fmm_reduce_kernel/hls/impl/verilog/project.cache/wt [current_project]
  set_property parent.project_path C:/GEMM/sep6/fmm_reduce_kernel/hls/impl/verilog/project.xpr [current_project]
  set_property ip_repo_paths C:/GEMM/sep6/fmm_reduce_kernel/hls/impl/ip [current_project]
  update_ip_catalog
  set_property ip_output_repo C:/GEMM/sep6/fmm_reduce_kernel/hls/impl/verilog/project.cache/ip [current_project]
