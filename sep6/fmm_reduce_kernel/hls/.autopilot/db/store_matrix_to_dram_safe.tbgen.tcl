set moduleName store_matrix_to_dram_safe
set isTopModule 0
...
set cdfgNum 28
set C_modelName {store_matrix_to_dram_safe}
...
set C_modelArgList {
	...
	{ M_e int 32 regular {array 102400 { 1 3 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "A_dram","offset": { "type": "dynamic","port_name": "A_dram","bundle": "control_r"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "M_e", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ M_e_address0 sc_out sc_lv 17 signal 4 } 
	{ M_e_ce0 sc_out sc_logic 1 signal 4 } 
	{ M_e_q0 sc_in sc_lv 32 signal 4 } 
}
set NewPortList {[ 
