set moduleName greedy_potential_reduce_with_debug_Pipeline_VITIS_LOOP_192_2_VITIS_LOOP_115_1
set isTopModule 0
...
set cdfgNum 28
set C_modelName {greedy_potential_reduce_with_debug_Pipeline_VITIS_LOOP_192_2_VITIS_LOOP_115_1}
...
set C_modelArgList {
	{ zext_ln192 int 31 regular  }
	{ s_4 int 32 regular  }
	{ cols_non_t int 32 regular  }
	{ mul_ln191 int 95 regular  }
	{ mul_ln117_1 int 17 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln192", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
 	{ "Name" : "s_4", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "cols_non_t", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "mul_ln191", "interface" : "wire", "bitwidth" : 95, "direction" : "READONLY"} , 
 	{ "Name" : "mul_ln117_1", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln192 sc_in sc_lv 31 signal 0 } 
	{ s_4 sc_in sc_lv 32 signal 1 } 
	{ cols_non_t sc_in sc_lv 32 signal 2 } 
	{ mul_ln191 sc_in sc_lv 95 signal 3 } 
	{ mul_ln117_1 sc_in sc_lv 17 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln192", "direction": "in", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "zext_ln192", "role": "default" }} , 
 	...
 	{ "name": "mul_ln191", "direction": "in", "datatype": "sc_lv", "bitwidth":95, "type": "signal", "bundle":{"name": "mul_ln191", "role": "default" }} , 
 	{ "name": "mul_ln117_1", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "mul_ln117_1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln192 { ap_none {  { zext_ln192 in_data 0 31 } } }
	s_4 { ap_none {  { s_4 in_data 0 32 } } }
	cols_non_t { ap_none {  { cols_non_t in_data 0 32 } } }
	mul_ln191 { ap_none {  { mul_ln191 in_data 0 95 } } }
	mul_ln117_1 { ap_none {  { mul_ln117_1 in_data 0 17 } } }
