set moduleName greedy_potential_reduce_with_debug_Pipeline_VITIS_LOOP_115_1
set isTopModule 0
...
set cdfgNum 28
set C_modelName {greedy_potential_reduce_with_debug_Pipeline_VITIS_LOOP_115_1}
