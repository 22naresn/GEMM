set moduleName greedy_potential_reduce_with_debug_Pipeline_VITIS_LOOP_163_2
set isTopModule 0
...
set cdfgNum 28
set C_modelName {greedy_potential_reduce_with_debug_Pipeline_VITIS_LOOP_163_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln163", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln163", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln163 sc_in sc_lv 32 signal 0 } 
	...
	{ sext_ln163 sc_in sc_lv 32 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln163", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "zext_ln163", "role": "default" }} , 
 	...
 	{ "name": "sext_ln163", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sext_ln163", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln163 { ap_none {  { zext_ln163 in_data 0 32 } } }
	...
	sext_ln163 { ap_none {  { sext_ln163 in_data 0 32 } } }
