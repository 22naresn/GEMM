...
set name fmm_reduce_kernel_mul_32ns_34ns_64_1_1
...
set name fmm_reduce_kernel_mul_64ns_31ns_95_3_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_debug_capacity \
    op interface \
    ports { debug_capacity { I 32 vector } } \
} "
}
