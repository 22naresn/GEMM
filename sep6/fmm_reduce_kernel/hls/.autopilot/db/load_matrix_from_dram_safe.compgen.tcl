...
set name fmm_reduce_kernel_mul_31ns_31ns_62_1_1
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_M_rows \
    op interface \
    ports { M_rows { O 32 vector } M_rows_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_M_cols \
    op interface \
    ports { M_cols { O 32 vector } M_cols_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_M_t \
    op interface \
    ports { M_t { O 32 vector } M_t_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { M_t_capacity { O 32 vector } M_t_capacity_ap_vld { O 1 bit } } \
} "
}
