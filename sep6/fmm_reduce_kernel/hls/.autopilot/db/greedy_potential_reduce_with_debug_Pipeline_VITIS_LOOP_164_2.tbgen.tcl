set moduleName greedy_potential_reduce_with_debug_Pipeline_VITIS_LOOP_164_2
set isTopModule 0
...
set cdfgNum 28
set C_modelName {greedy_potential_reduce_with_debug_Pipeline_VITIS_LOOP_164_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln164", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln164 sc_in sc_lv 32 signal 0 } 
	...
	{ sext_ln164 sc_in sc_lv 32 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln164", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "zext_ln164", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln164 { ap_none {  { zext_ln164 in_data 0 32 } } }
