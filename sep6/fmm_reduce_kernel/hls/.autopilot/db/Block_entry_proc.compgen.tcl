...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler fmm_reduce_kernel_Block_entry_proc_M_e_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_A_dram \
    op interface \
    ports { A_dram_dout { I 64 vector } A_dram_empty_n { I 1 bit } A_dram_read { O 1 bit } A_dram_num_data_valid { I 3 vector } A_dram_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { t_capacity_dout { I 32 vector } t_capacity_empty_n { I 1 bit } t_capacity_read { O 1 bit } t_capacity_num_data_valid { I 3 vector } t_capacity_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_k1 \
    op interface \
    ports { k1_dout { I 32 vector } k1_empty_n { I 1 bit } k1_read { O 1 bit } k1_num_data_valid { I 3 vector } k1_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_k2 \
    op interface \
    ports { k2_dout { I 32 vector } k2_empty_n { I 1 bit } k2_read { O 1 bit } k2_num_data_valid { I 3 vector } k2_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { debug_dram_dout { I 64 vector } debug_dram_empty_n { I 1 bit } debug_dram_read { O 1 bit } debug_dram_num_data_valid { I 3 vector } debug_dram_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { debug_capacity_dout { I 32 vector } debug_capacity_empty_n { I 1 bit } debug_capacity_read { O 1 bit } debug_capacity_num_data_valid { I 3 vector } debug_capacity_fifo_cap { I 3 vector } } \
} "
}
