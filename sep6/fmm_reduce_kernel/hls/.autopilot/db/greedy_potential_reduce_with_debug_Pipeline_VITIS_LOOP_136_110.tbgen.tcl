set moduleName greedy_potential_reduce_with_debug_Pipeline_VITIS_LOOP_136_110
set isTopModule 0
...
set cdfgNum 28
set C_modelName {greedy_potential_reduce_with_debug_Pipeline_VITIS_LOOP_136_110}
...
set C_modelArgList {
	{ new_col_3 int 32 regular  }
	{ mul_ln133 int 17 regular  }
	{ M_e int 32 regular {array 102400 { 0 1 } 1 1 }  }
	{ mul_ln134 int 17 regular  }
	{ mul_ln145 int 17 regular  }
	{ icmp_ln134 int 1 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "new_col_3", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "mul_ln133", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "M_e", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "mul_ln134", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "mul_ln145", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "icmp_ln134", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ new_col_3 sc_in sc_lv 32 signal 0 } 
	{ mul_ln133 sc_in sc_lv 17 signal 1 } 
	...
	{ mul_ln134 sc_in sc_lv 17 signal 3 } 
	{ mul_ln145 sc_in sc_lv 17 signal 4 } 
	{ icmp_ln134 sc_in sc_lv 1 signal 5 } 
	{ cmp34_i_i sc_in sc_lv 1 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "new_col_3", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "new_col_3", "role": "default" }} , 
 	{ "name": "mul_ln133", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "mul_ln133", "role": "default" }} , 
 	...
 	{ "name": "mul_ln134", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "mul_ln134", "role": "default" }} , 
 	{ "name": "mul_ln145", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "mul_ln145", "role": "default" }} , 
 	{ "name": "icmp_ln134", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "icmp_ln134", "role": "default" }} , 
...
set Spec2ImplPortList { 
	new_col_3 { ap_none {  { new_col_3 in_data 0 32 } } }
	mul_ln133 { ap_none {  { mul_ln133 in_data 0 17 } } }
	...
	mul_ln134 { ap_none {  { mul_ln134 in_data 0 17 } } }
	mul_ln145 { ap_none {  { mul_ln145 in_data 0 17 } } }
	icmp_ln134 { ap_none {  { icmp_ln134 in_data 0 1 } } }
