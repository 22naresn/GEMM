...
if {[file isfile fmm_reduce_kernel.autotvin.dat]} {
	file delete -force fmm_reduce_kernel.autotvin.dat
}

if {[file isfile fmm_reduce_kernel.autotvout.dat]} {
	file delete -force fmm_reduce_kernel.autotvout.dat
}
