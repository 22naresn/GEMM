...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fmm_reduce_kernel.autotvin_gmem.dat"
         "c.fmm_reduce_kernel.autotvin_A_dram.dat"
         "c.fmm_reduce_kernel.autotvin_rows.dat"
         "c.fmm_reduce_kernel.autotvin_cols.dat"
         "c.fmm_reduce_kernel.autotvin_t_capacity.dat"
         "c.fmm_reduce_kernel.autotvin_k1.dat"
         "c.fmm_reduce_kernel.autotvin_k2.dat"
         "c.fmm_reduce_kernel.autotvin_debug_dram.dat"
         "c.fmm_reduce_kernel.autotvin_debug_capacity.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fmm_reduce_kernel.autotvout_gmem.dat"
         "rtl.fmm_reduce_kernel.autotvout_gmem2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
