...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fmm_reduce_kernel.autotvin.dat"
	set constFileTvOut       "fmm_reduce_kernel.autotvout.dat"
	set constFileHdlTvIn     "fmm_reduce_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "fmm_reduce_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
